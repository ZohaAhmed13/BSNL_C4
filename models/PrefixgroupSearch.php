...
/**
 * PrefixgroupSearch represents the model behind the search form of `app\models\Prefixgroup`.
 */
class PrefixgroupSearch extends Prefixgroup
{
    /**
     * {@inheritdoc}
     */
